...
mats = dir(fullfile("results/hierarchal_neutral_competition/Fig2/matrices/", "timeseries*.mat"));
...
for i=1:length(mats)
    ...
    % Load matrix
    x_matrix = importdata("results/hierarchal_neutral_competition/Fig2/matrices/" + mat_filename);
    ...
    % Add title
    sgtitle(strcat("\epsilon = ", num2str(epsilon), ", \lambda = ", num2str(lambda)))
    ...
    fontsize(16, "points")
    plot_filename = "results/hierarchal_neutral_competition/Fig2/plots/" + erase(mat_filename, ".mat") + "_size.png";
