...
mats = dir(fullfile("results/hierarchal_neutral_competition/Fig4/matrices/", "clone1_timeseries*.mat"));
...
for mat=1:length(mats)
    ...
    % Load matrix
    x_matrix = importdata("results/hierarchal_neutral_competition/Fig4/matrices/" + mat_filename);

    % Load in variables
    load(replace(strcat("results/hierarchal_neutral_competition/Fig4/matrices/" + mat_filename), 'timeseries', 'variables'))
    ...
    fontsize(20, "points")
    plot_filename = "results/hierarchal_neutral_competition/Fig4/plots/" + erase(mat_filename, ".mat") + "_unscaled.png";
    ...
    % Save image (clone size across time)
    fontsize(20, "points")
    plot_filename = "results/hierarchal_neutral_competition/Fig4/plots/" + erase(mat_filename, ".mat") + "_scaled.png";
    exportgraphics(fig, plot_filename, 'Resolution', 300)
end
